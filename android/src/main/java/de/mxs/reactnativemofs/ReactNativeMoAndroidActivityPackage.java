...
public final class ReactNativeMoAndroidActivityPackage implements ReactPackage {
    ...
    public @Nonnull List<NativeModule> createNativeModules(@Nonnull ReactApplicationContext reactContext) {
        return Collections.singletonList(new ReactNativeMoAndroidActivity(reactContext));
    }
